...
#' @param data_Facies A data frame having colums with names id and Facies. id colum determines the id of a borehole and Facies colum contains the category of Facies
#' @param facies_color A vector with colors (color for each category) in alphabetical order of facies.
