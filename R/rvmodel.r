...
#'
#' @param azm azimuth (single value)
#'
#' @param dip dip (single value)
#'
#' @param nMC The number of Monte Carlo realizations (single value)
#'
#' @return An array of semi-variograms between rock type indicators (ncategory * ncategory * nlag matrix). In the case of co-simulation modeling the function returns a list including:
