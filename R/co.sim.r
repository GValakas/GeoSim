...
tmp <- datacoord %*% search_rotationmatrix  # **************22/01/23
...
simu2 <- cond_mooving_neigbor(m1, simu, nvar, nrealiz, datacoord, cc_residuals, coord, search_rotationmatrix,octant,ndata,nxsup, nysup, nzsup, xmnsup, ymnsup, zmnsup, xsizsup, ysizsup, zsizsup, ixsbtosr, iysbtosr, izsbtosr, nisb, model, sill, b, sillnugget, prepare_lines$model_rotationmatrix )
}
